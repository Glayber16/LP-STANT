...
function Team() {
  return (
    ...
    z<div className="xl:bg-[url(bg/bgBallsteam.png)] absolute inset-0 bg-[length:300px_2120px] xl:bg-right   xl:-top-[5rem] xl:-bottom-36 3xl:bg-right bg-no-repeat "></div>
