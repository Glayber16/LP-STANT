...
function Team() {
  return (
    ...
    z<div className="xl:bg-[url(bg/bgBallsteam.png)] absolute inset-0 bg-[length:300px_2120px] 2xl:left-[71.25rem] note:left-[68rem] xl:left-[64rem] xl:-top-[3rem] xl:-bottom-36 3xl:bg-right bg-no-repeat "></div>
