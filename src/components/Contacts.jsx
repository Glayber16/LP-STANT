    ...
    return(
        ...
        <div className="bg-[url(/bg/bgBall.png)] absolute inset-0 bg-[length:950px_780px] -top-[4rem] left-[4rem] opacity-50 bg-no-repeat  3xl:bg-center 3xl: -z-20 "> </div>
            ...
            <div className="bg-gray-50 flex-col align-middle justify-center items-center rounded-md border px-4 sm:px-9 py-11 xl:w-[35rem] xl:h-[26.65rem] text-violeta">
                ...
                <button className="bg-violeta border rounded-lg flex align-middle items-center sm:w-[18.7rem] sm:h-[4.8rem] w-[10rem] h-[2.4rem] text-center justify-center text-gray-50">ENVIAR</button>
                </div>
            </div>
            </div>
