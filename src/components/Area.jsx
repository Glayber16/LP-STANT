...
function Area() {
  return (
    <div id='area' className='bg-gradient-to-b from-area to-[#3728b4] font-michroma text-gray-50 flex flex-col py-24 '>
        <div className=' lg:text-[82px] 3xl:text-[105px] md:text-4xl text-xl flex justify-center text-center  md:justify-end lg:pb-16 md:pr-11 xl:pr-28 note:pr-20 3xl:pr-40 '> 
