...
function Area() {
  return (
    <div id='area' className='bg-gradient-to-b from-area to-[#3728b4] font-michroma text-gray-50 flex flex-col py-24 '>
        <div className=' xl:text-8xl 3xl:text-[3] md:text-4xl text-xl flex justify-center text-center  md:justify-end py-6 md:pr-11 3xl:pr-40 lg:[word-spacing:0.9rem]	'> 
