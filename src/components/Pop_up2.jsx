...
function Pop_up2({name1, name2, name3, text}) {
    ...
    return (
      ...
      <div className=" xl:-mt-4 flex flex-col ml-8 lg:ml-0 xl:ml-20  lg:mr-20 3xl:mr-40 3xl:mt-2 ">
        
        <button onClick={() => setPop_up (true)} className="cursor-pointer med:max-sm:mt-5 sm:mb-0  mr-8    lg:mr-24   xl:mr-16 xl:mt-16 ">{name1}</button>
          ...
          <button onClick={() => setPop_up (true)} className="cursor-pointer   sm:mr-36 mr-28  lg:mt-0  xl:mb-0 lg:mr-56 xl:mr-48">{name3}</button>
