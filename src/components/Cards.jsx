...
function Cards({role, image, description}) {
  return (
    ...
    <div className='bg-card flex flex-row rounded-lg 2xl:w-[24rem] 3xl:w-[30rem]  lg:h-[60rem] w-72 h-[68rem] mb-8 xl:w-80  lg:w-72 justify-center text-center px-3 xl:px-5'>
        ...
        <div className='flex justify-around xl:text-[27px]  lg:px-10  leading-[3.35rem]'>
            <h1>100+</h1>
            <h1>5mil</h1>
        </div>
