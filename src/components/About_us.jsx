...
function About_us() {
  return (
    ...
    <div className=' lg:bg-[url(bg/bgAbout.png)] bg-[length:460px_1000px]  bg-no-repeat -top-24 lg:left-[30rem] 2xl:left-[55.7rem] xl:left-[45rem] 3xl:bg-[length:500px_1100px] 3xl:bg-right 3xl:-top-80 3xl:right-36 inset-0 -z-10 absolute '> </div>
