    ...
    <div className=' lg:bg-[url(/bg/bgAbout.png)] 2xl:bg-[length:500px_1000px] lg:bg-[length:470px_1000px] bg-no-repeat 2xl:-top-[75rem] lg:-top-[76rem]  lg:ml-20 2xl:mr-20 3xl:mr-0  bg-right 3xl:bg-[length:500px_1100px] 3xl:bg-right 3xl:-top-[70rem] 3xl:right-36 inset-0 -z-10 absolute '> </div>
        ...
        <div className='flex flex-col sm:px-28 px-5 pt-10'> 
            ...
            <div className='flex lg:flex-row flex-col justify-between'>
             ...
             <div  className='flex sm:w-[33rem] pb-20 lg:pb-40 text-[22px] pt-48 font-normal xl:text-justify tracking-wider  '>
            ...
            <div className='flex flex-row text-4xl md:text-5xl lg:text-7xl sm:py-40 py-36 lg:py-0 bg-[url(/bg/bgAbout.png)] lg:bg-none bg-contain bg-no-repeat'>
                ...
                <div className='flex flex-col justify-around  lg:ml-0 xl:mr-10 2xl:h-[10rem] lg:h-[30rem] 3xl:h-[24rem]'> 
            ...
            <div className='justify-center items-center flex-col hidden font-thin sm:tracking-[0.2rem]'>
